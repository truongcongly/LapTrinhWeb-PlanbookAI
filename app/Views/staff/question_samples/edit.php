...
$title = 'Edit Question Sample - PlanbookAI';
$currentUser = Auth::user();
$pageTitle = 'Edit Question Sample';
$pageDesc = 'Chỉnh sửa câu hỏi mẫu';
$role = 'staff';
    ...
    <div class="col-xl-10 col-lg-11">
        <div class="dashboard-card">
            <div class="card-header-custom">
                <h5>Edit Question Sample Form</h5>
                <a href="/LapTrinhWeb-PlanbookAI/public/staff/question-samples" class="btn btn-outline-secondary rounded-pill px-4">
                    <i class="bi bi-arrow-left me-2"></i>Quay lại
                </a>
            </div>

            <form method="POST" action="/LapTrinhWeb-PlanbookAI/public/staff/question-samples/update?id=<?= $question['id']; ?>">
                <div class="row g-4">
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Môn học</label>
                        <input type="text" class="form-control form-control-lg rounded-4" name="subject" id="subjectInput" list="subjectList" value="<?= htmlspecialchars($question['subject']); ?>" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control form-control-lg rounded-4" name="topic" id="topicInput" list="topicList" value="<?= htmlspecialchars($question['topic']); ?>" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select form-select-lg rounded-4" name="correct_answer" required>
                            <option value="A" <?= (($question['correct_answer'] ?? 'A') === 'A') ? 'selected' : ''; ?>>A</option>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Load lại chủ đề theo môn hiện tại (nếu có)
...
$tempFile = sys_get_temp_dir() . '/staff_question_samples_edit.php';
